local LOCATION_DATA = {
	["Outside"] = {
		Min = Vector(-5639, -3711, -960),
		Max = Vector(2167, 6463, 9983),
	},
--[[ this causes a conflict with the secret room, needs to be fixed later
	["Lobby 2"] = {
	...
	["Dark Room Stairs"] = {
		Min = Vector(-5640, -3431, -144),
		Max = Vector(-5247, -2320, 384),
	},
	["Lobby 1"] = {
		Volumes = {
			{ Min = Vector(1028, -880, -144), Max = Vector(1791, 240, 32) },
			{ Min = Vector(1119, 240, -144), Max = Vector(1791, 896, 32) },
		},
	},
	["Secret Theater"] = {
	...
	["Color Room Theater"] = {
		...
		Theater = {
			Name = "Color Room Theater",
			Flags = THEATER_REPLICATED,
			Pos = Vector(-1527, -4567.25, 152),
			Ang = Angle(0, 180, 0),
			Width = 1042,
			Height = 408,
		}
