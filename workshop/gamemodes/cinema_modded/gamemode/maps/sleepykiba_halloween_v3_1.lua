...
Location.Add( "sleepykiba_halloween_v3_1",
{
	["Grand Cinema"] =
	{
	...
	[ "Backroom" ] =
	{
		Min = Vector( -4581, -5290, -752 ),
		Max = Vector( -2586, -3886, 84 ),
		Theater = {
			Name = "Backroom",
			Flags = THEATER_NONE,
			Pos = Vector( -2587.5, -4288, 71 ),
			Ang = Angle(0, -90, 0),
			Width = 282,
			Height = 172,
		}
	...
	[ "Silent Hill Theater" ]=
	{
		Min = Vector( 12216, -6389, 3227 ),
		Max = Vector( 12984, -5877, 3403 ),
		Theater = {
			Name = "Silent Hill Theater",
			Flags = THEATER_NONE,
			Pos = Vector( 12950.75, -6023, 3376.5 ),
			Ang = Angle(0, -90, 0),
			Width = 195,
			Height = 210 * 8.4 / 16,
		}
