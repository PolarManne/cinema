...
This is the unofficial successor to the [original addon](https://github.com/pixeltailgames/cinema) addon, the focus here is to keep the Cinema gamemode alive and enrich it with new features.
...
#### Credits ####
* The original developers of the [Cinema addon](https://github.com/pixeltailgames/cinema) by [PixelTail Games](https://www.pixeltailgames.com/).
...
* [Akiko Kumagara](https://www.youtube.com/@AkikoKumagara) & [Solstice Game Studios](https://github.com/solsticegamestudios) for the x86-64 / GModPatchTool Guide
